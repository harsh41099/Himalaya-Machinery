<%@ Page Language="VB" AutoEventWireup="false" CodeFile="spares.aspx.vb" Inherits="spares" %>
...
<%@ Register TagName="RightCustomerServiceSupport" TagPrefix="Control" Src="site-control/right-customer-service-support.ascx" %>
...
<body>
    ...
    <div class="container">
    <div class="iner-banner-title">Customer Service & Support</div>
    <div class="inside-page-link"><a href="index.aspx">Home</a><span class="span-space">»</span>Customer Service & Support<span class="span-space">»</span>Spares</div>
  </div>
...
<div class="container">
  <div class="himalya-top-bot-pd">
    <div class="title margin-bottom-30 bt-p">Spares</div>
    <div class="row">
      
      <div class="col-lg-9 col-md-9 col-sm-8 right-pd-iner">
          <div class="about-img margin-bottom-50"><img src="images/spares.jpg" class="img-responsive" alt=""/></div>
          
          <div class="txt-iner margin-bottom-30">
          <!--<div class="blue-title margin-bottom-20">Caring For The Old, Rearing For The New.</div>-->
            <p>At Himalaya, we are dedicated to the supply of service and spares. We maintain an adequate quantity of electrical parts, rubber components and other components to reduce chances of customer machine downtime. Spares are available for any machine, irrespective their age.</p>
          </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-4 margin-bottom-30">
        <Control:RightCustomerServiceSupport ID="RightCustomerServiceSupport1" runat="server" />
