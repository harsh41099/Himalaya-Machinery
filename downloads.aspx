<%@ Page Language="VB" AutoEventWireup="false" CodeFile="downloads.aspx.vb" Inherits="downloads_dynamic" %>
...
<body>
   ...
   <Control:Header ID="Header1" runat="server" />
    ...
    <div class="container">
    <div class="iner-banner-title">Downloads</div>
    <div class="inside-page-link"><a href="index.aspx">Home</a><span class="span-space">&raquo;</span>Downloads</div>
  </div>
...
<div class="col-lg-12 ">
        <div class="brd-bottom margin-bottom-30">Brochure</div>
        
    <div class="row">
        <asp:Repeater ID="rpDownloads" runat="server">
            <ItemTemplate>
                <div class="col-lg-4 col-md-4 col-sm-6 margin-bottom-30">
                    <div class="download-pdf-txt01 margin-bottom-20"><a href='download-details.aspx?dlid=<%# DataBinder.Eval(Container.DataItem,"DLID")%>' target="_blank"><%#FormatText(DataBinder.Eval(Container.DataItem,"DL_Title"))%></a></div>
                    <a class="gry22 ico2" href='download-details.aspx?dlid=<%# DataBinder.Eval(Container.DataItem,"DLID")%>' target="_blank">Download PDF File <span><i class="fa fa-file-pdf-o"></i></span></a>
                </div>
            </ItemTemplate>
        </asp:Repeater>
